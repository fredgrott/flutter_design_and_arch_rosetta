...
// Converted to null-safety modified from
// https://github.com/komapeb/data_connection_checker/blob/master/lib/data_connection_checker.dart
...
class DataConnectionChecker {
  ...
  /// thread { border-bottom: 2px solid lightgrey; }
  /// </style>
  ///
  ...
  DataConnectionChecker._() {
    ...
    _statusController.onCancel = () {
       _timerHandle!.cancel();
      //late  dynamic _lastStatus = null; // reset last status
  ...
  Future<bool> get hasConnection async {
    ...
    _lastTryResults = List.unmodifiable(await Future.wait<dynamic>(requests));
