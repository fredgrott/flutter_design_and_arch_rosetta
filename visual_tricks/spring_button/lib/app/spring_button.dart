// Original code MIT license and copyright by
// Cosmos Software | Ali Yigit Bireroglu
//
// Modifications by Fredrick Allan Grott and licensed under
// a BSd-clause 2 license
...
class SpringButtonState extends State<SpringButton>
  ...
  void springDown() {
    ...
    if (_debugLevel > 0) log("springDown");
  ...
  Future spring() async {
    if (!isEnabled) return;
    // original had a print statement, never ever print in production code
    if (_debugLevel > 0) log("spring-1");
  ...
  Future springUp() async {
    ...
    if (_debugLevel > 0) log("springUp-1");
    ...
    if (_debugLevel > 0) log("springUp-2");

    if (!isSpringDown) animationController.value = 1;
  }

  //TODO reduce cycle complexity of this through refactoring
  Widget get wrapper {
