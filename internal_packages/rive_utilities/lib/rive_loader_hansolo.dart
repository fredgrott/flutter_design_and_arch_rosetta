...
import 'package:rive_utilities/rive_controller_hansolo.dart';


class RiveLoaderHanSolo extends StatefulWidget {
  final String name;
  ...
  @override
  RiveLoaderHanSoloState createState() => RiveLoaderHanSoloState();
}

class RiveLoaderHanSoloState extends State<RiveLoaderHanSolo> {
  late RiveControllerHanSolo _controller;
  ...
  void initState() {
    ...
    rootBundle.load(widget.name).then(
      (data) async {
        ...
        _controller = RiveControllerHanSolo(
  ...
  @override
  void didUpdateWidget(RiveLoaderHanSolo oldWidget) {
