...
class RiveControllerHanSolo extends RiveAnimationController<RuntimeArtboard> {
  LinearAnimationInstance? _instance;

  final VoidCallback onFinished;
  late final String animationName;
  Loop ourLoop = Loop.pingPong;
  ...
  RiveControllerHanSolo(this.animationName,  this.onFinished,
      {double mix = 1,})
      : _mix = mix.clamp(0, 1);
