            ...
            children: [
              WidgetAnimator(
                child: ProjectCard(
                  ...
                  projectDescription: kContactDetails[0], backImage: '', bottomWidget: const SizedBox(), key: const Key("card"), projectIcon: '', projectLink: '',
                ),
              ),
              SizedBox(
                width: width * 0.02,
              ...
              WidgetAnimator(
                child: ProjectCard(
                  ...
                  projectDescription: kContactDetails[1], backImage: '', bottomWidget: const SizedBox(), key: const Key("card"), projectIcon: '', projectLink: '',
                ),
              ),
              SizedBox(
                width: width * 0.02,
              ...
              WidgetAnimator(
                child: ProjectCard(
                  ...
                  projectDescription: kContactDetails[2], backImage: '', key: const Key("card"), bottomWidget: const SizedBox(), projectIcon: '', projectLink: '',
                ),
              ),
            ],
          ),
